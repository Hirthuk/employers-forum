        ...
        <div className="w-full max-w-6xl grid gap-8 md:grid-cols-2 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight">
              Insight Hub — <span className="gradient-text">Appreciate. Connect. Grow.</span>
            </h1>

            <p className="text-slate-400 text-sm sm:text-base max-w-prose">
              Insight Hub is an internal platform for employees to appreciate peers, share wins,
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-md p-6 glass-panel rounded-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-semibold text-white text-center relative">Insight Hub — Celebrate wins</h3>
